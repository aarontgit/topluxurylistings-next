    ...
    <div className="pt-28">
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 max-w-3xl mx-auto p-6 space-y-6">
          ...
          <p>
            At <strong>Top Luxury Listings</strong>, we are committed to protecting your
            privacy. This policy outlines how we collect, use, and safeguard your personal
            information.
          </p>
          ...
          <div>
            ...
            <p>
              We do <strong>not</strong> sell or share your data with third parties. Your
              information is securely stored and used solely for service delivery.
            </p>
          </div>
          ...
          <div>
            ...
            <p>These providers may collect limited technical data as part of their service.</p>
          </div>
          ...
          <p>
            ...
            contacting us at{" "}
            <a
              href="mailto:support@topluxurylistings.com"
              className="text-blue-600 underline"
            >
              support@topluxurylistings.com
            </a>
            . We retain information only as needed to provide services or fulfill legal
            obligations.
          </p>
